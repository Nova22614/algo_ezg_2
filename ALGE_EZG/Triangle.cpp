...
bool Triangle::triBoxOverlap(glm::vec3 boxcenter, glm::vec3 boxhalfsize) {
	...
	v0 = points[0] - boxcenter;
	v1 = points[1] - boxcenter;
	v2 = points[2] - boxcenter;
...
inline void Triangle::findMinMax(float x0, float x1, float x2, float& min, float& max) {
	min = max = x0;
	if (x1 < min)
		min = x1;
	if (x1 > max)
...
inline bool Triangle::planeBoxOverlap(glm::vec3 normal, glm::vec3 vert, glm::vec3 maxbox) {
	glm::vec3 vmin, vmax;
	float v;
...
inline bool Triangle::axisTestX01(float a, float b, float fa, float fb, const glm::vec3& v0,
...
inline bool Triangle::axisTestX2(float a, float b, float fa, float fb, const glm::vec3& v0,
...
inline bool Triangle::axisTestY02(float a, float b, float fa, float fb, const glm::vec3& v0,
	const glm::vec3& v2, const glm::vec3& boxhalfsize, float& rad, float& min,
	float& max, float& p0, float& p2) {
	p0 = -a * v0.x + b * v0.z;
	p2 = -a * v2.x + b * v2.z;
...
inline bool Triangle::axisTestY1(float a, float b, float fa, float fb, const glm::vec3& v0,
	const glm::vec3& v1, const glm::vec3& boxhalfsize, float& rad, float& min,
	float& max, float& p0, float& p1) {
	p0 = -a * v0.x + b * v0.z;
	p1 = -a * v1.x + b * v1.z;
...
/*======================== Z-tests ========================*/
inline bool Triangle::axisTestZ12(float a, float b, float fa, float fb, const glm::vec3& v1,
	const glm::vec3& v2, const glm::vec3& boxhalfsize, float& rad, float& min,
...
inline bool Triangle::axisTestZ0(float a, float b, float fa, float fb, const glm::vec3& v0,
	const glm::vec3& v1, const glm::vec3& boxhalfsize, float& rad, float& min,
	float& max, float& p0, float& p1) {
	p0 = a * v0.x - b * v0.y;
	p1 = a * v1.x - b * v1.y;
